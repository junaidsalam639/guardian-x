import TopActions from "@/components/(user)/dashboard-card/top-actions";
import TopSeverity from "@/components/(user)/dashboard-card/top-severity";
import TopAttack from "@/components/(user)/dashboard-card/top-attack";
import TopSourceIp from "@/components/(user)/dashboard-card/top-source-ip";
import TopDestinationIp from "@/components/(user)/dashboard-card/top-destination-ip";
import TopSourceCountries from "@/components/(user)/dashboard-card/top-source-countries";
import TopDestinationCountries from "@/components/(user)/dashboard-card/top-destination-countries";
import AuthenticationFailedAttempts from "@/components/(user)/dashboard-card/authentication-failed-attempts";
import AuthenticationSuccessAttempts from "@/components/(user)/dashboard-card/authentication-success-attempts";
import TopUserLast24H from "@/components/(user)/dashboard-card/top-user-last-24h";
import TopSSHDSourceIp from "@/components/(user)/dashboard-card/top-sshd-src-ip";
